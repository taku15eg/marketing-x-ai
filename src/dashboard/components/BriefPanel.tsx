      ...
      <div className="p-5 space-y-5">
        ...
        <section>
          <div className="flex items-center gap-2 mb-2">
            ...
            <h5 className="text-xs font-bold text-[#1B3A5C] uppercase tracking-wider">
              目的
            </h5>
          </div>
          <p className="text-sm text-gray-800 leading-relaxed pl-4">
            {brief.objective}
          </p>
        </section>
        ...
        {brief.qa_checklist.length > 0 && (
          <section>
            <div className="flex items-center gap-2 mb-2">
              ...
              <h5 className="text-xs font-bold text-green-700 uppercase tracking-wider">
                QAチェックリスト
              </h5>
            </div>
            <ul className="pl-4 space-y-1.5">
